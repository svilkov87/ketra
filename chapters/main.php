                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="act_item">
                            ...
                            <div class="act_desc">
                                <div class="desc_head">Получи поддон блоков в подарок!</div>
                                <p>* При заказе машины блоков</p>
                                <div class="strike"><span>Суперпредложение!</span></div>
                            </div>
                            <img class="gift" src="app/img/product_img/icons8-Gift-100.png" alt="alt">
                        </div>
                    </div>
